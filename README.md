...
| 釋字與憲判字 | 870 筆 | 大法官解釋 813 筆、憲法法庭判決 57 筆 |
| 行政規則（函釋・令函） | 83,778 筆 | 字號精確查詢＋語義檢索（hosted MCP），78 個發布機關，部會別明細見下表 |
| 函釋效力履歷 | 50,800+ 筆 | 廢止／停止適用／被取代狀態追蹤，引用前驗效力 |
| 不當勞動行為裁決（勞動部裁決委員會） | 400 筆 | 勞動議題查詢自動並列，明確標示為裁決、非法院判決 |
| 憲法 | 1 部 | 中華民國憲法 197 條，含增修條文 12 條。[dr-lawbot.com](https://dr-lawbot.com) 站上檢索 |
| 法律 | 1,083 部／45,620 條 | 定名為法、律、條例或通則者（中央法規標準法 §2）。同上 |
| 命令 | 7,474 部／132,760 條 | 定名為規程、規則、細則、辦法、綱要、標準或準則者（同法 §3）。同上 |
| 已廢止法規 | 3,230 部 | 法律 254 部、命令 2,974 部，及動員戡亂時期臨時條款等憲法位階規範，標示廢止狀態供查考沿革 |
...
- **22,527,498 筆**台灣裁判資料（截至 2026-08-20），經過結構化處理與向量化。
...
- **行政函釋雙工具**——字號精確查詢（附效力狀態：已驗證有效／未驗證／已廢止／
