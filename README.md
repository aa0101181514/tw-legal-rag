...
台灣裁判語義檢索服務（22,578,975 筆，截至 2026-09-08）,讓你能用自然語言搜尋判決,並將檢索結果帶入自己的 AI 工具使用。

## 資料涵蓋（統計截至 2026-09-08，取自 production 資料庫）
...
| 命令 | 行政規則 | 88,392 筆 | 90 個機關發布之解釋性規定與裁量基準（行政程序法 §159），對外不生法規範效力 |
...
| 函釋效力履歷 | 69,483 筆 | 廢止／停止適用／被取代狀態追蹤，引用前驗效力 |
...
### 行政規則發布機關明細（90 個機關，統計日 2026-09-08）
...
- **22,578,975 筆**台灣裁判資料（截至 2026-09-08），經過結構化處理與向量化。
